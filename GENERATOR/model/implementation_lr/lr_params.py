...
class LR_Params(DGP_Params):

    """ Inplementation of DGP_Params, used for Linear Regression Data Generating Process """
    
    def __init__(self, seed=None, n_variables=None, error_variance=None, \
        n_points=None, related_vars=None, n_scales=None, requested_mean=None, unuseful_vars=None,betas=None):
        ...
        self.validate_params_and_create_obj(seed, n_variables, error_variance, \
            n_points, related_vars, n_scales, requested_mean, unuseful_vars, betas)


    def validate_params_and_create_obj(self, seed=None, n_variables=None, error_variance=None, n_points=None, \
        related_vars=None, n_scales=None, requested_mean=None, unuseful_vars=None, betas=None, gen_x_means=True):
