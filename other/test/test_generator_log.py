...
from model.simple_access.functions import Elements
...
class LR_Test(TestCase):
    ...
    def test_01_generated_dataset_without_opt(self):
        ...
        example_dataset = pd.read_csv(os.path.join(os.getcwd(), "input", "test_generator_log", "dataset_float64.csv"), header=None)
        example_betas = pd.read_csv(os.path.join(os.getcwd(), "input", "test_generator_log", "betas_float64.csv"), header=None)
        example_corr_matrix = pd.read_csv(os.path.join(os.getcwd(), "input", "test_generator_log", "corr_matrix_float64.csv"), header=None)
        example_cov_matrix = pd.read_csv(os.path.join(os.getcwd(), "input", "test_generator_log", "cov_matrix_float64.csv"), header=None)

        # must convert ample from DataFrame to Series for checking equality
        example_betas = example_betas.iloc[:, 0]

        elements = IOfunctions.get_input(os.path.join("test_generator_log", "input_elements_float64.json"))
    ...
    def test_02_generated_dataset_with_opt_level_1(self):
        ...
        example_dataset = pd.read_csv(os.path.join(os.getcwd(), "input", "test_generator_log", "dataset_float32.csv"), header=None)
        example_betas = pd.read_csv(os.path.join(os.getcwd(), "input", "test_generator_log", "betas_float32.csv"), header=None)
        example_corr_matrix = pd.read_csv(os.path.join(os.getcwd(), "input", "test_generator_log", "corr_matrix_float32.csv"), header=None)
        example_cov_matrix = pd.read_csv(os.path.join(os.getcwd(), "input", "test_generator_log", "cov_matrix_float32.csv"), header=None)
        ...
        elements = IOfunctions.get_input(os.path.join("test_generator_log", "input_elements_float32.json"))
        results = Generator.by_input(elements)
    ...
    def test_03_generated_dataset_with_opt_level_2(self):
        ...
        example_dataset = pd.read_csv(os.path.join(os.getcwd(), "input", "test_generator_log", "dataset_float16.csv"), header=None)
        example_betas = pd.read_csv(os.path.join(os.getcwd(), "input", "test_generator_log", "betas_float16.csv"), header=None)
        example_corr_matrix = pd.read_csv(os.path.join(os.getcwd(), "input", "test_generator_log", "corr_matrix_float16.csv"), header=None)
        example_cov_matrix = pd.read_csv(os.path.join(os.getcwd(), "input", "test_generator_log", "cov_matrix_float16.csv"), header=None)
        ...
        elements = IOfunctions.get_input(os.path.join("test_generator_log", "input_elements_float16.json"))
        results = Generator.by_input(elements)
    ...
    def test_04_generated_dataset_chunk(self):
        ...
        example_dataset = pd.read_csv(os.path.join(os.getcwd(), "input", "test_generator_log_chunk", "dataset_chunk.csv"), header=None)
        
        elements = IOfunctions.get_input(os.path.join("test_generator_log_chunk", "input_elements_chunk.json"))
        results = Generator.by_input(elements)
        #I read the output of the generation
        dataset = pd.read_csv(os.path.join(os.getcwd(), "output", "test_generator_log_chunk", "dataset.csv"), header=None)
